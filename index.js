...
const cryptoDashTableElement = document.getElementById("crypto-dash");
const cryptoColumns = [
    {
        tagName: "img",
...
const fetchCryptoData = async () => {
    ...
    const requestUrl = "https://api.coingecko.com/api/v3/coins/markets?vs_currency=us&order=market_cap_desc&per_page=10&page=1&sparkline=false";
